                ...
                database.child("user").addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                       if (dataSnapshot.hasChild(username)) {
                           Toast.makeText(getContext(), "Username is already registered", Toast.LENGTH_LONG).show();
                           ...
                           Toast.makeText(getContext(),"user has successfuuly registered", Toast.LENGTH_LONG).show();
                           goToLogin();
                       }
                    }
